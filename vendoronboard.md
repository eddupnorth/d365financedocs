...
Create a form in Microsoft From Pro
This from link you post to your website where people can access and show interest to do business.

How to create form.

Open you browser and type : www.forms.office.com
From will open.
...
For adding any new you have to determine the field type


What is your organization name?

Is its solo trade or company (select the from drop down “1. Person 2. Organization”)

Do you have any Organization number?
...
Contact number of your organization

Contact email ID

Why you want to do business with us and what you want to supply us?
...
Open the browser and write https://preview.flow.microsoft.com. Make sure you are in correct CDS data base. Make sure you have sign in with same office 365 id with Microsoft Form Pro.
Microsoft Flow will be open, click the connector.
...
I have not used much advance option, if you need you can use the same.
...
18.Define you D365 Fin Ops server name and select the data entity. Data entity you select “ProspectVendorRegisterationRequests”

Moment you complete both the step , action “create record” will be enlarge and it will open many Items for mapping.
...
Open the browser and write https://portal.azure.com  .Make sure you have full administrator right in Azure portal on respective subscription.
Once login to azure portal. Select the “Azure Active Directory – > App Registration -> New Registration
...
System administration module -> Setup -> B2B Invitation Configuration

2. Click Edit -> Enable (yes)
...
System administration module -> Workflow -> User workflow -> Create new
...
Procurement & Sourcing Module -> Setup -> Procurement & Sourcing Parameter -> Vendor collaboration tab
...
Procurement & Sourcing Module -> Setup -> Procurement & Sourcing workflow -> New -> configure “vendor add application workflow”

2. Here is my configuration, single approval


All setup done, now its time to execute the process…….
...
Mr. Paul received the notification about Mr. Gao Interest. Mr. Paul given a call and understand what Mr. Gao want to offer. Mr. Paul decided to move forward with Mr. Gao company.

Mr. Paul want to invite Mr. Gao’s company B2B invite where Gao Lim JV Pte Ltd, other details can be submitted for further evaluation process.
...
Open Outlook.com
Put Mr. Gao email id which he provided last time in the interest form.
Mr. Gao got the invite
...
Procurement & sourcing -> Vendor -> Vendor collaboration -> Vendor request.
...
Try the link which provided by Paul & Associate Inc IT Team.

Hope this will help all D365 Fin Ops consultants who want to leverage Microsoft Azure Platform.
